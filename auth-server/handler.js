...
/**
 * SCOPES allows you to set access levels; this is set to readonly for now because you dont have access rights to
...
const credentials = {
  ...
  redirect_uris: ['https://sunnyyuanz.github.io/meet-app/'],
  javascript_origins: ['https://sunnyyuanz.github.io', 'http://localhost:3000'],
};
...
module.exports.getAuthURL = async () => {
   ...
   * scoped are the ones users will see when the consent screen is displayed to them.
   *
   */
